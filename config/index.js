export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx9d0c16c49c3b55d0",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "f863073563a3b74f2ddd41dfe1010db2",
   ...
   */
  USERS: [o2w4g5uW5Ihd7XoKMW-Vt6mjaQSY],
    {
      // 想要发送的人的名字
      name: "小媳妇儿",
      ...
      id: "",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "ULeE-G3F1omYm6ctEm3ee5xQvqQiWOezYEUCcjwVPLc	",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "石家庄",
  ...
  CALLBACK_TEMPLATE_ID: "o2w4g5uW5Ihd7XoKMW-Vt6mjaQSY",
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "o2w4g5uW5Ihd7XoKMW-Vt6mjaQSY",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
